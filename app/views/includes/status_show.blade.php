...
<div id="comment_add_warning" class="alert alert-warning alert-dismissible hide" role="alert">
    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    <strong>No text in comment.</strong> Nothing was added. Please contact support if this is not working.
</div>
